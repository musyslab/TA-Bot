    ...
    return (
      <div className="oh-page">
        <header className="oh-header">
          <h2 className="section-title">In-Person Office Hours</h2>
        </header>
            ...
            <table className="table queue-table">
              ...
              <tbody className="table-body">
                ...
                {this.state.Student_questions.length === 0 && (
                  <tr className="table-row">
                    <td colSpan={3} className="empty">No active students in the queue.</td>
                  </tr>
                )}
              </tbody>
            </table>
        ...
        <section className="panel panel-join">
          ...
          <form className="form form-join">
            ...
            <button
              ...
              disabled={this.state.questionAsked || !Number.isInteger(this.state.selectedProject as number)}
              aria-disabled={this.state.questionAsked || !Number.isInteger(this.state.selectedProject as number)}
            >
              Join Queue
            </button>
          </form>
...
const OfficeHoursWithParams = () => {
  ...
  return <OfficeHoursComponent class_id={class_id} />;
};

export default OfficeHoursWithParams;
export { OfficeHoursComponent };